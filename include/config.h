...
#define UBWT_CONFIG_VERSION_STR				"0.1-beta-10"
...
#define UBWT_CONFIG_PROCESS_REVERSE_DELAY_SEC		3
...
//#define UBWT_CONFIG_NET_NO_TIMEOUT			0
...
//#define UBWT_CONFIG_PTHREAD_CUSTOM_BARRIER		0
//#define UBWT_CONFIG_PTHREAD_LOCAL_STORAGE		0
//#define UBWT_CONFIG_MISSING_INET_NTOP_DECL		0
//#define COMPILE_WIN32					0
...
#if defined(UBWT_CONFIG_NET_NO_TIMEOUT) && (UBWT_CONFIG_NET_NO_TIMEOUT == 0)
 #undef UBWT_CONFIG_NET_NO_TIMEOUT
#endif
...
#if defined(UBWT_CONFIG_PTHREAD_CUSTOM_BARRIER) && (UBWT_CONFIG_PTHREAD_CUSTOM_BARRIER == 0)
 #undef UBWT_CONFIG_PTHREAD_CUSTOM_BARRIER
#endif

#if defined(UBWT_CONFIG_PTHREAD_LOCAL_STORAGE) && (UBWT_CONFIG_PTHREAD_LOCAL_STORAGE == 0)
 #undef UBWT_CONFIG_PTHREAD_LOCAL_STORAGE
#endif

#if defined(UBWT_CONFIG_MISSING_INET_NTOP_DECL) && (UBWT_CONFIG_MISSING_INET_NTOP_DECL == 0)
 #undef UBWT_CONFIG_MISSING_INET_NTOP_DECL
#endif
 ...
 #undef COMPILE_WIN32
...
#ifndef UBWT_CONFIG_NET_USE_SETSOCKOPT
  ...
  #define UBWT_CONFIG_NET_NO_UDP 1
 #endif
 #ifndef UBWT_CONFIG_NET_NO_TIMEOUT
  #define UBWT_CONFIG_NET_NO_TIMEOUT 1
 #endif
#endif

#ifdef UBWT_CONFIG_NET_NO_TIMEOUT
 #ifndef UBWT_CONFIG_NET_NO_UDP
  #define UBWT_CONFIG_NET_NO_UDP 1
 #endif
#endif

#ifdef UBWT_CONFIG_NET_NO_UDP
...
struct ubwt_config {
	...
	uint32_t net_payload_buffer_size;
